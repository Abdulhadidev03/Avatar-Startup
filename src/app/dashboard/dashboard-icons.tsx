...
export function RuhanaLogo({ compact = false }: { compact?: boolean }) {
  return (
    <div className="ruh-logo" aria-label="Ruhana">
      <svg className="ruh-logo-mark" aria-hidden="true" viewBox="0 0 30 30">
